...
public abstract class ReversibleMultiCaretInsightAction extends MultiCaretCodeInsightAction implements DumbAware {
    ...
    if (e == null) {
      throw new IllegalArgumentException(
          String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "e",
              "com/mulgasoft/emacsplus/actions/ReversibleMultiCaretInsightAction", "actionPerformed"));
    }
  ...
  private void iterateCarets(@NotNull final Project project, @NotNull final Editor hostEditor,
    ...
    if (project == null) {
      throw new IllegalArgumentException(
          String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "project",
              "com/mulgasoft/emacsplus/actions/ReversibleMultiCaretInsightAction", "iterateCarets"));
    }
    if (hostEditor == null) {
      throw new IllegalArgumentException(
          String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "hostEditor",
              "com/mulgasoft/emacsplus/actions/ReversibleMultiCaretInsightAction", "iterateCarets"));
    }
    if (handler == null) {
      throw new IllegalArgumentException(
          String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "handler",
              "com/mulgasoft/emacsplus/actions/ReversibleMultiCaretInsightAction", "iterateCarets"));
    }
