...
public class KillCmdUtil
{
    ...
    public static String getTransferableText(@NotNull final Transferable data) {
        ...
        if (transferableText == null) {
            throw new IllegalStateException(String.format("@NotNull method %s.%s must not return null", "com/mulgasoft/emacsplus/util/KillCmdUtil", "getTransferableText"));
        }
    ...
    public static String getTransferableText(@NotNull final Transferable data, @NotNull final String lineSepr) {
        ...
        if (lineSepr == null) {
            throw new IllegalArgumentException(String.format("Argument for @NotNull parameter '%s' of %s.%s must not be null", "lineSepr", "com/mulgasoft/emacsplus/util/KillCmdUtil", "getTransferableText"));
        }
